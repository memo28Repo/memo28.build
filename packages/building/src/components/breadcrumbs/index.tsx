 ...
 * @LastEditTime: 2023-10-22 15:57:18
 * @Description: 
 * @FilePath: /buildingRepo/packages/building/src/components/breadcrumbs/index.tsx
 */
            ...
            <Breadcrumbs maxItems={2} aria-label="breadcrumb">
                {
                    list.map((route, routeIndex) => {
                        return <>
                            {route.disable ?
                                <Typography key={routeIndex}>{route.name}</Typography>
                                :
