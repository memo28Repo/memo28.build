 ...
 * @LastEditTime: 2023-11-11 10:39:45
 * @Description:
...
import { useUser } from '~/hooks/useStoreHelper'
...
const Index: FC<PropsWithChildren<unknown>> = () => {
    ...
    return <div className="flex justify-center items-center flex-col h-screen w-screen">
        <div className='text-3xl mb-11 font-black transform duration-300 slide-in-blurred-right '>
            @memo.com/building
        </div>
